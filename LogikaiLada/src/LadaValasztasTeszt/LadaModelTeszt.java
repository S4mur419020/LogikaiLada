...
public class LadaModelTeszt {
    ...
    public static void main(String[] args) {
        LogikaiLadaController cteszt = new LogikaiLadaController();
        LadaModell mteszt = new LadaModell();
        cteszt.tesztKincsTalalat();
        //cteszt.tesztVisszajelzesSzoveg();
        //cteszt.tesztHibasLadaAzonosito();

//        mteszt.tesztFeliratok();
//        mteszt.tesztKincsesLada();
//        mteszt.tesztNemLetezoLada();
